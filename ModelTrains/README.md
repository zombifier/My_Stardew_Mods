...
here>`. The spritesheet is laid out similarly to an NPC's spritesheet; you want four rows for
down/right/up/left idling and moving sprites.
...
The sheets' tile size is 3x2, and the sprite index is the same as the BC item's original sprite
